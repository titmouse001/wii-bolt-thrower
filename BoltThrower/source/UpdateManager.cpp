...
string CreateString()
{
	...
	GA_Parameters.push_back("&utmhid=" + GetRandom9DigitDecimalAsString() );
	...
	GA_Parameters.push_back("&utmcc=__utma%3D" +
							 CreateHashString("code.google.com") +		// Domain hash ... i.e. 247248150 for "code.google.com"
							 "." + GetRandom9DigitDecimalAsString() +	// Unique Identifier ... i.e. ".233226017"
							 ...
							 "__utmz%3D" +				// "__utmz="
							 CreateHashString("code.google.com") +	// Domain Hash  ...
